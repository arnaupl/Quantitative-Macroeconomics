...
THE CODE SOLVES ITEM II.5.1 OF THE HOMEWORK :SOLVE AYAGARI (1994)
...
#Importantly, the parametrization in Ayagari (1994)
...
class Household:
    ...
    def __init__(self,
                 ...
                 a_min=0,
                 Π=[[0.5, 0.1, 0.2, 0.045, 0.105, 0.015, 0.035], [0.05, 0.5, 0.25, 0.05, 0.05, 0.05, 0.05], [0.05, 0.2, 0.3, 0.2, 0.15, 0.05, 0.05], [0.1, 0.1, 0.1, 0.4, 0.1, 0.1, 0.1],[0.05, 0.05, 0.05, 0.05, 0.6, 0.1, 0.1],[0.1, 0.05, 0.05, 0.1, 0.2, 0.3, 0.2],[0.06, 0.06, 0.07, 0.1, 0.1, 0.1, 0.51]],  # Markov chain
...
#%% 
#Compute Gini and compare with Krueger, Mitman and Perri (2016), but now with Ayagari (1994) parameters.
